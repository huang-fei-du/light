...
#define   LOAD_CTRL_CLOCK       0x12      /*负荷控制时钟*/
#define   READ_GATEK_VALUE      0x13      /*读取门控值*/
#define   SET_BATTERY_CHARGE    0x14      /*后备充电管理*/
#define   READ_SWITCH_KH        0x15      /*开合盖检测*/
#define   ESAM_RST              0x16      /*ESAM算法安全芯片 - 复位引脚*/
#define   MACHINE_TYPE            88      /*通知机型*/
#define   ESAM_DEBUG_INFO         89      /*通知打开/关闭ESAM芯片的调试信息*/
